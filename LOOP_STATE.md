...
1. **admin A0:** Next.js panel — `packages/ui` başlangıcı (Button/Input/DataTable/StatCard/EmptyState) + AppShell + auth guard iskeleti + feature-sliced boundary lint (docs/03). Web W0 çekirdeği ✓ (test+waitlist+archetype sayfaları iter #13-14).
