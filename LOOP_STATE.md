...
1. **web W0 frontend:** `/test` sayfası (public questions ✓ + `POST /v1/archetype/web` ✓ tüketir) + sonuç/paylaşım + `/a/{archetype}` sayfaları + waitlist formu (API ✓ iter #12). Web test altyapısı (vitest/testing-library) kurulacak.
