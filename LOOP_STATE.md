...
1. **web W0 devam:** `/a/{archetype}` archetype landing sayfaları (SEO/GEO içerik, paylaşım kartı hedefi) + `/test` sonuç sayfasında paylaşım kartı/OG (docs/05). Test sayfası + waitlist ✓ iter #13.
