...
export interface paths {
    ...
    "/v1/admin/soundscapes/{slug}/publish": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Soundscape yayinla (bos ses tarifi reddedilir) */
        post: operations["AdminController_publish"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/admin/soundscapes/{slug}/unpublish": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Soundscape yayindan kaldir (taslaga dondurur) */
        post: operations["AdminController_unpublish"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/me/sounds": {
        ...
        /** Kendi paylaşımlarım ve durumları */
        get: operations["CommunityController_mine"];
        put?: never;
        /** Yükleme slotu aç: kayıt + presigned PUT URL */
    ...
    "/v1/me/sounds/{id}/uploaded": {
        ...
        get?: never;
        put?: never;
        /** PUT bitti bildirimi — depoda HEAD ile doğrulanır */
        post: operations["CommunityController_uploaded"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/admin/community-sounds": {
        ...
        /** Moderasyon listesi (durum filtreli) */
        get: operations["AdminCommunityController_list"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/admin/community-sounds/{id}/file": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        /** Moderatör önizlemesi: kısa ömürlü dinleme URL’i (10 dk) */
        get: operations["AdminCommunityController_file"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/v1/admin/community-sounds/{id}/moderate": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
        ...
        get?: never;
        put?: never;
        /** Onayla / reddet (redde gerekçe zorunlu) */
        post: operations["AdminCommunityController_decide"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        SetRecipeDto: {
            ...
            /**
             * @description Mikser katmanları (1–8); type: white|pink|brown|waves|fire|rain|pad|tone|chords|arpeggio|ceramic|chimes|topSpin|friction, gain 0–1
             * @example [
             *       {
             *         "id": "base",
             *         "type": "pink",
        ...
        MixerLayerDto: {
             ...
             * @enum {string}
             */
            type: "white" | "pink" | "brown" | "waves" | "fire" | "rain" | "pad" | "tone" | "chords" | "arpeggio" | "ceramic" | "chimes" | "topSpin" | "friction";
            /** @example 0.5 */
            gain: number;
        };
        MixerStateDto: {
        ...
        CreateSoundUploadDto: {
            /** @example Yağmurlu balkon */
            title: string;
            /** @example 1800 */
            durationSeconds: number;
        };
        ...
        UserSoundDto: {
            ...
            title: string;
            status: string;
            byteSize: Record<string, never> | null;
            durationSeconds: number;
...
export interface operations {
    ...
    CommunityController_mine: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["UserSoundDto"][];
                };
            };
        };
    };
    CommunityController_create: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["CreateSoundUploadDto"];
            };
        };
        responses: {
            201: {
                ...
                content: {
                    "application/json": components["schemas"]["SoundUploadSlotDto"];
                };
            };
        };
    };
    CommunityController_uploaded: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody?: never;
        responses: {
            /** @description Dosya doğrulandı, moderasyon kuyruğunda */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    AdminCommunityController_list: {
        ...
        responses: {
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["AdminUserSoundDto"][];
                };
            };
        };
    };
    AdminCommunityController_file: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    AdminCommunityController_decide: {
        parameters: {
            query?: never;
            header?: never;
            path: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["ModerateSoundDto"];
            };
        };
        responses: {
            200: {
