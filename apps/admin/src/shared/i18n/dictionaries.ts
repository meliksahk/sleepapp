...
export const dictionaries = {
  tr: {
    ...
    'dashboard.deletedAccounts': 'Silinen hesap',
    'dashboard.deletedAccountsHint': 'son 30 gün — kimliksiz sayaç',
    ...
    'nav.plan': 'Plan',
    'plan.title': 'Plan (ödeme çerçevesi)',
    'plan.subtitle': 'Ücretsiz ile premium arasındaki sınır. Salt okunur: sınır kodda yaşıyor.',
    'plan.notConnected':
      'ÖDEME BAĞLI DEĞİL. Sunucu bugün HERKESE premium (plus) dönüyor; aşağıdaki sınır bir sözdür, uygulanan bir kural değil. Gerçek IAP en son fazda bağlanacak (docs/10).',
    'plan.freeHeading': 'Her zaman ücretsiz',
    'plan.freeMixer': 'Mikserin tamamı, her katman, sınır yok.',
    'plan.freeRecordings': 'Kullanıcının kendi kayıtları ve uyku zamanlayıcısı.',
    'plan.freeLibrary': 'Kütüphaneden {count} ses.',
    'plan.freeMixes': '{count} kayıtlı mix.',
    'plan.premiumHeading': 'Premium ile',
    'plan.feature.fullLibrary': 'Ses kütüphanesinin tamamı.',
    'plan.feature.infiniteExtension': 'Sabaha kadar hiç tekrar etmeyen ses.',
    'plan.feature.offline': 'Çevrimdışı dinleme.',
    'plan.feature.smartAlarm': 'Akıllı alarm.',
    'plan.feature.unlimitedMixes': 'Sınırsız kayıtlı mix.',
    'plan.feature.videoExport': "Mix'i video olarak dışa aktarma.",
    'plan.feature.weeklyTrends': 'Haftalık trendler.',
    'plan.trialHeading': 'Deneme',
    'plan.trialBody':
      '{days} gün, ödeme öncesi tam erişim. Bugün deneme de BAŞLAMIYOR: ödeme bağlanmadan bir deneme sayacı tutmak, tutmayacağımız bir söz olurdu.',
  ...
  en: {
    ...
    'dashboard.deletedAccounts': 'Deleted accounts',
    'dashboard.deletedAccountsHint': 'last 30 days — identity-free counter',
    ...
    'nav.plan': 'Plan',
    'plan.title': 'Plan (billing frame)',
    'plan.subtitle': 'The line between free and premium. Read-only: the line lives in code.',
    'plan.notConnected':
      'PAYMENTS ARE NOT CONNECTED. The server returns premium (plus) for EVERYONE today; the boundary below is a promise, not an enforced rule. Real IAP is wired in the last phase (docs/10).',
    'plan.freeHeading': 'Always free',
    'plan.freeMixer': 'The whole mixer, every layer, no limits.',
    'plan.freeRecordings': "The user's own recordings and the sleep timer.",
    'plan.freeLibrary': '{count} sounds from the library.',
    'plan.freeMixes': '{count} saved mixes.',
    'plan.premiumHeading': 'With premium',
    'plan.feature.fullLibrary': 'The full sound library.',
    'plan.feature.infiniteExtension': 'Sound that never repeats, all night.',
    'plan.feature.offline': 'Offline listening.',
    'plan.feature.smartAlarm': 'The smart alarm.',
    'plan.feature.unlimitedMixes': 'Unlimited saved mixes.',
    'plan.feature.videoExport': 'Export a mix as video.',
    'plan.feature.weeklyTrends': 'Weekly trends.',
    'plan.trialHeading': 'Trial',
    'plan.trialBody':
      '{days} days of full access before any payment. The trial does not start today either: keeping a trial counter without payments wired would be a promise we cannot keep.',
