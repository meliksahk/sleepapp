...
export const dictionaries = {
  tr: {
    ...
    'nav.flags': 'Bayraklar',
    'community.title': 'Topluluk sesleri',
    'community.subtitle': 'Kullanıcı paylaşımları — onaylananlar katalogda görünür.',
    'community.noPermission': 'Bu bölüm için editör yetkisi gerekir.',
    'community.tabPending': 'Bekleyenler',
    'community.tabApproved': 'Onaylı',
    'community.tabRejected': 'Reddedilenler',
    'community.filterLabel': 'Durum filtresi',
    'community.empty': 'Bu durumda kayıt yok.',
    'community.approve': 'Onayla',
    'community.reject': 'Reddet',
    'community.reasonPlaceholder': 'Red gerekçesi (zorunlu)',
    'community.rejectConfirm': 'Reddi gönder',
    'community.errorConflict': 'Bu kayıt başka bir kararla güncellendi; listeyi yenileyin.',
    'community.errorReasonRequired': 'Red için gerekçe zorunludur.',
    'community.errorGeneric': 'Karar uygulanamadı.',
    'community.loadFailed': 'Liste yüklenemedi. Sayfayı yenileyin.',
    'community.play': 'Dinle',
    'community.hidePlayer': 'Kapat',
    ...
    'content.layerFrequencyHz': 'Frekans (20–2000 Hz)',
    'content.layerBeatHz': 'Vuru Hz — boş = mono (0.5–20)',
  ...
  en: {
    ...
    'nav.flags': 'Flags',
    'community.title': 'Community sounds',
    'community.subtitle': 'User uploads — approved sounds appear in the catalog.',
    'community.noPermission': 'Editor permission required for this section.',
    'community.tabPending': 'Pending',
    'community.tabApproved': 'Approved',
    'community.tabRejected': 'Rejected',
    'community.filterLabel': 'Status filter',
    'community.empty': 'Nothing here.',
    'community.approve': 'Approve',
    'community.reject': 'Reject',
    'community.reasonPlaceholder': 'Rejection reason (required)',
    'community.rejectConfirm': 'Send rejection',
    'community.errorConflict': 'This item was updated by another decision; refresh the list.',
    'community.errorReasonRequired': 'A rejection reason is required.',
    'community.errorGeneric': 'The decision could not be applied.',
    'community.loadFailed': 'Could not load the list. Refresh the page.',
    'community.play': 'Listen',
    'community.hidePlayer': 'Hide player',
    ...
    'content.layerFrequencyHz': 'Frequency (20–2000 Hz)',
    'content.layerBeatHz': 'Beat Hz — empty = mono (0.5–20)',
