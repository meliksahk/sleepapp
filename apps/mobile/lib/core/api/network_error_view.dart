...
class NetworkErrorView extends StatelessWidget {
  ...
  /// Ağ AÇIKKEN gösterilecek ekrana özgü metin ("Paylaşımların yüklenemedi").
  /// Verilmezse genel `loadFailed`. Ağ kapalıyken her zaman dürüst metin
  /// (`loadFailedNoServer`) gösterilir; ekrana özgü metin orada yanıltırdı.
  ...
  Widget build(BuildContext context) {
    ...
    return NErrorState(
      retryKey: retryKey,
      message: hasApi
          ? (onlineMessage ?? l10n.loadFailed)
          : l10n.loadFailedNoServer,
