...
import { ContentModule, ListAllSoundscapesUseCase } from '../content';
...
const providers: Provider[] = [
  {
    ...
    inject: [ListAllSoundscapesUseCase],
    useFactory: (listAll: ListAllSoundscapesUseCase): SoundscapeCatalog => ({
      list: async () => {
